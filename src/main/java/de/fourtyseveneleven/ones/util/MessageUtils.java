...
import static de.fourtyseveneleven.ones.configuration.message.ExceptionMessageConfiguration.DEFAULT_LOCALE;
import static java.util.Objects.isNull;

import java.util.Locale;

import de.fourtyseveneleven.ones.configuration.message.ExceptionMessageConfiguration;
