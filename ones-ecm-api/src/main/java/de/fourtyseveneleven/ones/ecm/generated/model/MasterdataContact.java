...
public class MasterdataContact {
  ...
  private Set<MasterdataContactAddress> addresses = null;

  public static final String JSON_PROPERTY_ROLES = "_roles";
  private Set<MasterdataContactRole> roles = null;
  ...
  **/
  ...
  public MasterdataContact addresses(Set<MasterdataContactAddress> addresses) {
  ...
  **/
  ...
  public Set<MasterdataContactAddress> getAddresses() {
    return addresses;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ADDRESSES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAddresses(Set<MasterdataContactAddress> addresses) {
    this.addresses = addresses;
  }


  public MasterdataContact roles(Set<MasterdataContactRole> roles) {
    this.roles = roles;
    return this;
  }
  ...
  **/
  ...
  public Set<MasterdataContactRole> getRoles() {
    return roles;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ROLES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setRoles(Set<MasterdataContactRole> roles) {
    this.roles = roles;
  }
